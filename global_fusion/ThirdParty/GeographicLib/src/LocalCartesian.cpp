...
namespace GeographicLib {
  ...
  void LocalCartesian::Reset(real lat0, real lon0, real h0) {
    ...
    _h0 = h0;
    printf("_lat0:%d  _lon0:%d", _lat0, _lon0);
    _earth.Forward(_lat0, _lon0, _h0, _x0, _y0, _z0);
    printf("_x0 : %d   _y0 : %d   _z0 : %d \n", _x0, _y0, _z0);
...
//    _x0 = 1544590817.400102;
    xc -= _x0; yc -= _y0; zc -= _z0;//这x is irrational and z is unstable
//    printf("x:%d  y:%d  z:%d \n", _x0, _y0, _z0);
