...
PinholeCamera::Parameters::readFromYamlFile(const std::string& filename)
{
    ...
    //resize images
    double IMAGE_RATIO;//<<<image_ratio
    IMAGE_RATIO = static_cast<double>(fs["image_ratio"]);//<<<image_ratio

    m_imageWidth = round(IMAGE_RATIO * m_imageWidth);//<<<image_ratio
    m_imageHeight = round(IMAGE_RATIO * m_imageHeight);//<<<image_ratio
    m_fx *= IMAGE_RATIO;//<<<image_ratio
    m_fy *= IMAGE_RATIO;//<<<image_ratio
    m_cx *= IMAGE_RATIO;//<<<image_ratio
    m_cy *= IMAGE_RATIO;//<<<image_ratio

    printf("相机模型为PINHOLE================================================= %d x %d \n", m_imageWidth, m_imageHeight);
